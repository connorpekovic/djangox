...
from .views import HomePageView, DetailView, CreateCBView, UpdateCBView, DeleteCBView, UserAlreadyVotedView
...
class HomepageTests(SimpleTestCase):
    ...
    def test_homepage_template(self):
        self.assertTemplateUsed(self.home_response, 'pages/home.html')

    # Assert the setUp responce(parm1) contains a str(parm2) and a coded http responce code(parm3).
    def test_homepage_contains_correct_html(self):
        self.assertContains(self.home_response, 'Home', status_code=200)
